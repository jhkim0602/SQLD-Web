    ...
    <div className="prose-ko">
      ...
      {weakCategories.length > 0 && (
        <section className="mt-8">
          <h2 className="text-lg font-bold text-zinc-900">카테고리별 정답률</h2>
      ...
      <section className="mt-8">
        <div className="flex items-center justify-between">
          <h2 className="text-lg font-bold text-zinc-900">문제별 리뷰</h2>
            ...
            return (
              <li
                ...
                className={cn(
                  ...
                  e.isC ? "border-emerald-200" : "border-rose-200"
                )}
              >
                <button
                ...
                >
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <div className="mt-0.5 line-clamp-2 text-sm text-zinc-800">
                      {e.q.question}
                    </div>
                  </div>
